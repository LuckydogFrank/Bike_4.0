...
CREATE TABLE `admin` (
  ...
  `a_pid` int(11) DEFAULT NULL COMMENT '管理的地方id 管理员此处为空',
  ...
  `a_role` varchar(20) DEFAULT NULL COMMENT '用户,管理员',
...
insert  into `admin`(`aid`,`a_pid`,`a_username`,`a_password`,`a_real_name`,`a_phone`,`a_role`,`a_icon`,`a_login_time`,`a_create_time`,`a_update_time`,`a_comment`) values (1,2,'ming','08373931bedde3e6492c93e8fdbd75fe','ming','123123','用户','images/adminIcon/15185929940555370.jpg','2018-02-15 16:03:18','2018-02-09 13:53:01','2018-02-15 16:03:18',NULL),(2,NULL,'admin','08373931bedde3e6492c93e8fdbd75fe','007',NULL,'管理员','images/adminIcon/管理员.png','2018-02-15 15:57:54','2018-02-12 15:56:55','2018-02-15 15:57:54',NULL),(3,4,'123','08373931bedde3e6492c93e8fdbd75fe','阿拉利','123','用户','images/adminIcon/15186746679804600.jpg',NULL,'2018-02-15 14:04:27','2018-02-15 14:04:27',NULL);
